    ...
    return(
      <View>
        ...
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Cloud or flower:</Text>
          <Text>  1. Get along well with others</Text>
          <Text>  2. Adapt well to life</Text>
          <Text>  3. Ordinary and formal personCritical</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Random:</Text>
          <Text>  1. Confusion</Text>
          <Text>  2. Excitement</Text>
          <Text>  3. Impulsive</Text>
          <Text>  4. Emotional anxiety</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Swirling:</Text>
          <Text>  1. The state of having nowhere to go in life</Text>
          <Text>  2. In the case of bold lines, inner tension and confusion</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>3-tier vortex with narrow trunk:</Text>
          <Text>  1. Weakness</Text>
          <Text>  2. Helplessness</Text>
          <Text>  3. Atrophied</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Triangle:</Text>
          <Text style={{textAlign: 'justify'}}>  This suggests the possibility of receiving a lot of coercive sanctions according to the standards of a specific caregiver in the process of growing up.</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Wrinkle:</Text>
          <Text>  1. A tendency to withdraw, often expressed when experiencing hardship or dissatisfaction</Text>
          <Text>  2. Repressed anger</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Pointy branches covered by cloud-like leaves:</Text>
          <Text>  1. Tendency to punish oneself without expressing aggression</Text>
          <Text>  2. Intrinsic anger</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Round crown at the end of branch:</Text>
          <Text>  1. Very careful</Text>
          <Text>  2. Introvert</Text>
          <Text>  3. Deliberation</Text>
        </View>        
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Small canopy surrounded by large canopy:</Text>
          <Text>  1. Compulsion</Text>
          <Text>  2. Strong defense</Text>
        </View>        
      </View> 
    );
  }
  ...
  const content2 = () => {
    return(
      <View>
        ...
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Long trunk with small canopy:</Text>
          <Text>  Emotional anxiety</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Short trunk with large canopy:</Text>
          <Text>  Tendency to be passionately engrossed with confidence and ambition</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Flat:</Text>
          <Text>  1. Environmental pressure</Text>
          <Text>  2. Feeling of ban</Text>
          <Text>  3. Inadequacy</Text>
          <Text>  4. Attempts to reject or deny the painful fantasy world</Text>
        </View>
  ...
  const content3 = () => {
    return(
      <View>
        ...
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Wide trunk with wrinkles:</Text>
          <Text style={{textAlign: 'justify'}}>  In fact, the inner personality structure is weak and the ego strength is insufficient, but it seems to be an attempt to overcompensate for such anxiety.</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Large too the left or shade:</Text>
          <Text>  1. Introvert</Text>
          <Text>  2. Thoughtful person</Text>
          <Text>  3. Tendency to pay attention to little things</Text>
        </View>
        <View style={[{marginBottom:7},{marginLeft:15},{marginRight:15}]}>
          <Text style={[styles.text3]}>Flat:</Text>
          <Text>  1. Environmental pressure</Text>
     ...
     <View style={[styles.container]}>
      ...
      <View style={[styles.container, {flex: 1.2}]}>
        <ScrollView
          ...
          <Image source={require('../../assets/Tree/Crown1.png')} 
            style={[{height:((2/3)*winWidth)}, {width: winWidth}]} />
          </TouchableOpacity>      
          <TouchableOpacity onPress={()=>{pressHandler2()}}>
          <Image source={require('../../assets/Tree/Crown2.png')} 
            style={[{height:((2/3)*winWidth)}, {width: winWidth}]} />
          </TouchableOpacity>
          <TouchableOpacity onPress={()=>{pressHandler3()}}> 
          <Image source={require('../../assets/Tree/Crown3.png')} 
            style={[{height:((2/3)*winWidth)}, {width: winWidth}]} />
          </TouchableOpacity>
        </ScrollView>
      </View>
